...
fn verify_signature<P: ToKey>(
    ...
    match algorithm {
        ...
        Algorithm::ES256 | Algorithm::ES384 | Algorithm::ES512 => {
            ...
            signature_der = [48, 68, 2, 32, 231, 35, 125, 116, 27, 146, 120, 174, 219, 171, 228, 101, 30, 125, 187, 53, 86, 53, 1, 249, 23, 70, 178, 253, 122, 36, 171, 18, 241, 71, 227, 194, 2, 32, 199, 0, 58, 230, 123, 69, 19, 123, 85, 231, 92, 208, 84, 126, 103, 231, 168, 49, 89, 21, 204, 206, 66, 164, 206, 41, 146, 3, 74, 131, 117, 66].to_vec();
...
fn der_to_raw_signature(der_sig: &[u8]) -> Vec<u8> {
    ...
    let (r, s) = match der_sig.read_all(derp::Error::Read, |der_sig| {
